  ...
  return (
    <div className="create-post">
      ...
      <div className="create-post__footer">
        <button className="btn create-post__footer-btn">
          <svg
            fill="currentColor"
            viewBox="0 0 24 24"
            width="1em"
            height="1em"
            className="a8c37x1j ms05siws l3qrxjdp b7h9ocf4 fxtw5amg rgmg9uty b73ngqbp">
        ...
        <button className="btn create-post__footer-btn">
          <svg
            ...
            width="1em"
            height="1em"
            className="a8c37x1j ms05siws l3qrxjdp b7h9ocf4 j58f7537 rgmg9uty b73ngqbp">
            <g fillRule="evenodd" transform="translate(-444 -156)">
              <g>
                <path
        ...
        <button className="btn create-post__footer-btn">
          <svg
            ...
            width="1em"
            height="1em"
            className="a8c37x1j ms05siws l3qrxjdp b7h9ocf4 mu8pnim0 rgmg9uty b73ngqbp">
            <g fillRule="evenodd" transform="translate(-444 -156)">
              <g>
                <path
